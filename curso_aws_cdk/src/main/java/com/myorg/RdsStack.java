...
public class RdsStack extends Stack {
    ...
    public RdsStack(final Construct scope, final String id, final StackProps props, Vpc vpc) {
        ...
        iSecurityGroup.addIngressRule(Peer.anyIpv4(), Port.tcp(3306)); // sõ dispositivos dentro da VPC acessem o RDS

        // criando a instancia do RDS
        ...
        // exporta parâmetros de entrada
        CfnOutput.Builder.create(this, "rds-endpoint")
                .exportName("rds-endpoint")
                .value(databaseInstance.getDbInstanceEndpointAddress()) // devolve o endpoint de acesso ao Banco de dados no RDS
                .build();

        // exporta parâmetros de entrada
        CfnOutput.Builder.create(this, "rds-password")
                .exportName("rds-password")
                .value(databasePassword.getValueAsString()) // devolve a senha de acesso ao Banco de dados no RDS
                .build();
    }
}
